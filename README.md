...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/ip-lookup-visualizer.git
   cd ip-lookup-visualizer
   ```
...
[![Repo](https://img.shields.io/badge/ip-lookup-visualizer-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/ip-lookup-visualizer)
